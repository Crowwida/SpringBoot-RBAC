 ...
 */
@Component
public class RbacInvocationSecurityMetadataSourceService implements FilterInvocationSecurityMetadataSource {
    ...
    public RbacInvocationSecurityMetadataSourceService() {}
